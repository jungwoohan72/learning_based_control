...
class ENVIRONMENT : public RaisimGymEnv {
 ...
 public:
  ...
  void curriculumUpdate() {
    ...
    if (high_counter % 200 == 0 && warm_up >= 1000 && warm_up <= 4800) {
        high_counter = 0;
        xPos_init_high += 1;
        yPos_init_high += 1;
    }

    if (high_inter_counter % 500 == 0 && warm_up >= 5000 && warm_up <= 9800) {
        high_inter_counter = 0;
        xPos_init_high += 1;
        yPos_init_high += 1;
    }

    if (low_counter % 1000 == 0 && warm_up >= 1000 && warm_up <= 3000) {
        low_counter = 0;
        xPos_init_low += 1;
        yPos_init_low += 1;
    }
 ...
 private:
  ...
  int xPos_init_high = 5;
  int yPos_init_high = 5;
  int xPos_init_low = 2;
  int yPos_init_low = 2;
